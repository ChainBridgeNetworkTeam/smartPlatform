...
var hAddredd = '0x1251129cfe52B685A6038fD3C50EbaC75Ce44c20';
//  mainnet private key
var mainPriviteKey = '';
var geoliPrivateKey = '0xf97df4c7d3412bd607cb31e659bd30f557b85792bb128bde797341c8e3ecec7a';
function main() {
    return __awaiter(this, void 0, void 0, function () {
        var data, jsonData, provider, wallet, deployType, factory, contract;
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (deployType === '-p') {
                        ...
                        wallet = new ethers_1.ethers.Wallet(mainPriviteKey, provider);
                    }
                    else if (deployType == '-g') {
                        //  goerli环境
                        provider = ethers_1.ethers.getDefaultProvider('goerli');
                        wallet = new ethers_1.ethers.Wallet(geoliPrivateKey, provider);
                    }
                    else {
                        //  测试环境
